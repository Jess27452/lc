...
#For minHeap, the time complexity is:
...
# this part put the first rond of most recent twtte frome ach user
...
#1: [[0,5],[-1,7]],
#2: [[-2,10],[-3,11]]
#}then self.tweetMap[1]returns:[[0,5],[-1,7]] which represents User 1's tweets.
